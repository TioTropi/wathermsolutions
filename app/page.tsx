          ...
          <div className="space-y-12">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-muted-foreground mb-1">Sin Tratamiento</div>
                  <div className="text-3xl font-bold text-foreground">3-5 años</div>
                </div>
                <div className="text-right">
                  <div className="text-sm text-muted-foreground">Vida útil promedio</div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-muted-foreground mb-1">Con Tratamiento Watherm</div>
                  <div className="text-3xl font-bold text-foreground">15-20 años</div>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 text-sm font-semibold">
